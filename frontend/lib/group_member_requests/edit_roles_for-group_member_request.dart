...
Future<List<String>> edit_members_roles_of_a_group(String group_id,int g_index,String member_username,List<String> user_updated_roles) async {
  String temp_mssg = "";
  ...
  Map data_to_be_sent = {'token': jwt_token,'username': member_username,'roles': user_updated_roles};
  var body = JsonEncoder().convert(data_to_be_sent);
  print(body);
  var returned_all_roles_response = await http.post(
      Uri.parse('$global_link/api/members/$group_id/editMemberRole'),

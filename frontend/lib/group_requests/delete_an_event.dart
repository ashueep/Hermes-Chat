...
Future<List<String>> delete_event_request(
    String event_id, String group_id) async {
  String temp_mssg = "";
  bool success_var = false;
  Map data_to_be_sent = {'token': jwt_token, 'id': event_id};
  var body = JsonEncoder().convert(data_to_be_sent);
  print(body);
  var returned_create_new_role_response = await http.post(
      Uri.parse('$global_link/api/events/$group_id/deleteEvent'),

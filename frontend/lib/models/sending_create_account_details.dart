...
Future<List<String>> send_create_account(String name, String password,String email,String UserName) async {
  List<String> response_to_be_returned = [];
  String temp_message = "";
  String temp_level1="";
  bool temp_create_account_status = true;
  String create_account_status;
  Map Login_data = {'username': UserName, 'fullname': name, 'password': password, 'email': email,};
  ...
  else if(returned_create_account_result.statusCode==200 || returned_create_account_result.statusCode==201){

...
Future<List<String>> CreateNewDM(String username) async {
  ...
  var returned_login_result = await http.post(
      Uri.parse('http://192.168.116.1:3000/api/dms/create'),
    ...
    if(temp_message=="DM created")
      {
        ...
        DM_users temp_friend=DM_users(username: username, u_id: user_id_to_create_DM, full_name: full_name_of_created_DM);
